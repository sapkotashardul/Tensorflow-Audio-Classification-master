...
def inference_wav(wav_file):
    ...
    with tf.Session(graph=graph, config=SESS_CONFIG) as sess:
        ...
        with VGGishExtractor(VGGISH_CKPT,  #Realoding the VGGishExtractor which has trained by the tensorflow people
                         VGGISH_PCA,
            ...
            for t in tf.trainable_variables(scope=None):
                print(t)
        ...
        _restore_from_defined_and_ckpt(sess, CKPT)  #Loading the final fully connectedl layere
