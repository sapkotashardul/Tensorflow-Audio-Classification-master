...
def load_vggish_slim_checkpoint(session, checkpoint_path):#This is to extract the pretrained classifier checkpoints
...
def load_defined_vggish_slim_checkpoint(session, checkpoint_path):  #This is to restore the feature extrtactor checkpoint 
  """Loads a pre-trained VGGish-compatible checkpoint.
  ...
  saver2.save(session,'/home/dl/Documents/CINA/Tensorflow-Audio-Classification-master/new_ckpt' + '/' + 'ckpt')
